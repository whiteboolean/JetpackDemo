...
class PhotoFragment : Fragment() {
    ...
    val viewModel by activityViewModels<MyPagerListViewModel>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.submitList(parcelableArrayList)
        viewpager2.setCurrentItem(currentPosition?:0, false)
        textView36.text = "${currentPosition?:0 + 1}/${parcelableArrayList?.size}"
